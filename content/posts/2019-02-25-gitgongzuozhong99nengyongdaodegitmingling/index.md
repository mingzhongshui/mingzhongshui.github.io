---
date: 2019-02-25T11:52:00+00:00
categories: ["日常"]
title: 【Git】工作中99%能用到的git命令
slug: gitgongzuozhong99nengyongdaodegitmingling
#description: 分支操作1.gitbranch创建分支2.gitchecko
tags: ["git", "总结向"]
featured: false
draft: false
excerpt: 分支操作1.gitbranch创建分支2.gitcheckoutb创建并切换到新建的分支上3.gitcheckout切换分支4.gitbranch查看分支列表5.gitbranchv查看所有分支的最后
---
...
## 分支操作 ##
 ...
 12. git push origin --delete 分支名 删除远处仓库分支

 13. git merge 分支名  合并分支到当前分支上

 14. git push --set-upstream origin 分支名 / git push origin 分支名 将本地分支推送到远程仓库

 15. git checkout -b 本地分支名 origin/远程分支名 下载远程仓库分支到本地
